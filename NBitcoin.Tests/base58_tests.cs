...
namespace NBitcoin.Tests
{
	...
	{
		public static IEnumerable<object[]> DataSet => new[] {
        ...
        [Xunit.Theory, MemberData("DataSet")]
		...
		public void ShouldThrowFormatExceptionOnInvalidBase58()
		{
            ...
            // Act
            var ex = Record.Exception(() => Encoders.Base58.DecodeData(" "));
            // Assert
		...
		public void base58_keys_valid_parse()
		{
			...
			foreach(var test in tests)
			{
				...
				network = isTestnet ? Network.TestNet : Network.Main;
		...
		[Xunit.Theory, MemberData("InvalidKeys")]
